    ...
    return Scaffold(
      ...
      body: Center(
        ...
        child: Column(
          ...
          children: <Widget>[
            RaisedButton(
                child: Text('C : Create'), onPressed: () => writeData()),
            RaisedButton(child: Text('R : Read'), onPressed: () => readData()),
            RaisedButton(
                child: Text('U : Update'), onPressed: () => updateData()),
            RaisedButton(
                child: Text('D : Delete'), onPressed: () => deleteData()),
            Text(
              val,
            ),
            // Text(
